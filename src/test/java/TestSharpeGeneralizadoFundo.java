...
public class TestSharpeGeneralizadoFundo {
     ...
     */
    @Test
    public void testIndiceSharpeG1() throws SQLException, ClassNotFoundException {
        ...
        // Sharpe Generalizado
        BigDecimal sharpeG = investFundsManager.calcular_sharpe_generalizado_fundo();
        BigDecimal sharpeGDiferenca = new BigDecimal("1.819728689").subtract(sharpeG).abs();
        Assert.assertTrue(sharpeGDiferenca.compareTo(EPSILON) <= 0);
    }
     ...
     */
    @Test
    public void testIndiceSharpeG2() throws SQLException, ClassNotFoundException {
        List<BigDecimal> rentabilidadeDiariaFundos = Arrays.asList(
        ...
        // Sharpe Generalizado
        BigDecimal sharpeG = investFundsManager.calcular_sharpe_generalizado_fundo();
        BigDecimal sharpeGDiferenca = new BigDecimal("-0.05049882956").subtract(sharpeG).abs();
        Assert.assertTrue(sharpeGDiferenca.compareTo(EPSILON) <= 0);
    }
     ...
     */
    @Test
    public void testIndiceSharpeG3() throws SQLException, ClassNotFoundException {
        List<BigDecimal> rentabilidadeDiariaFundos = Arrays.asList(
        ...
        // Sharpe Generalizado
        BigDecimal sharpeG = investFundsManager.calcular_sharpe_generalizado_fundo();
        BigDecimal sharpeGDiferenca = new BigDecimal("1.762896716").subtract(sharpeG).abs();
        Assert.assertTrue(sharpeGDiferenca.compareTo(EPSILON) <= 0);
    }
}
