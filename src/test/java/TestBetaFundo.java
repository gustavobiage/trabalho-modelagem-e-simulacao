...
public class TestBetaFundo {
     ...
     */
    @Test
    public void testIndiceBeta1() throws SQLException, ClassNotFoundException {
        ...
        // Beta
        BigDecimal beta = investFundsManager.calcular_beta_fundo();
        BigDecimal betaDiferenca = new BigDecimal("-1.849906207").subtract(beta).abs();
        Assert.assertTrue(betaDiferenca.compareTo(EPSILON) <= 0);
    }
     ...
     */
    @Test
    public void testIndiceBeta2() throws SQLException, ClassNotFoundException {
        List<BigDecimal> rentabilidadeDiariaFundos = Arrays.asList(
        ...
        // Beta
        BigDecimal beta = investFundsManager.calcular_beta_fundo();
        BigDecimal betaDiferenca = new BigDecimal("-0.3404733623").subtract(beta).abs();
        Assert.assertTrue(betaDiferenca.compareTo(EPSILON) <= 0);
    }
     ...
     */
    @Test
    public void testIndiceBeta3() throws SQLException, ClassNotFoundException {
        List<BigDecimal> rentabilidadeDiariaFundos = Arrays.asList(
        ...
        // Beta
        BigDecimal beta = investFundsManager.calcular_beta_fundo();
        BigDecimal betaDiferenca = new BigDecimal("0.4862976948").subtract(beta).abs();
        Assert.assertTrue(betaDiferenca.compareTo(EPSILON) <= 0);
    }
}
